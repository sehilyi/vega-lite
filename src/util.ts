 ...
 * // → {'a': 1, 'c': 3}
 */
export function pick<T extends Dict<unknown>, K extends keyof T>(obj: T, props: readonly K[]): Pick<T, K> {
  const copy: any = {};
 ...
 */
export function omit<T extends Dict<unknown>, K extends keyof T>(obj: T, props: readonly K[]): Omit<T, K> {
